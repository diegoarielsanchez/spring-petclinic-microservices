...
nohup java -jar spring-eprescribing-prescribers-service/target/*.jar --server.port=8084 --spring.profiles.active=chaos-monkey > target/prescribers-service.log 2>&1 &
